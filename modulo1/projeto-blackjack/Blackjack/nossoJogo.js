...
if (confirm("Quer iniciar uma nova rodada?")) {
   ...
   console.log(`Usuário - cartas: ${usuarioNumUm.texto} ${usuarioNumDois.texto} - pontuação ${pontosUsuario}`)
   ...
   console.log(`Computador - cartas: ${computadorNumUm.texto} ${computadorNumDois.texto} - pontuação ${pontosComputador}`)
